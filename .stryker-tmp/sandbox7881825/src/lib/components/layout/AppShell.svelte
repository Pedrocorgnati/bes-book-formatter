<script lang="ts">
  ...
  function handleKeydown(e: KeyboardEvent) {
    ...
    if (mod && e.key === 'i') {
      e.preventDefault();
      window.dispatchEvent(new CustomEvent('bes:navigate', { detail: '/import' }));
    }
  }
...
<div data-testid="app-shell" class="app-shell" class:sidebar-collapsed={sidebarCollapsed} class:panel-collapsed={rightPanelCollapsed}>
  ...
  <header data-testid="header" class="app-shell__header">
    ...
    <button
      ...
      aria-label={sidebarCollapsed ? t('a11y.expandMenu') : t('a11y.collapseMenu')}
    ...
    <button
      ...
      aria-label={rightPanelCollapsed ? t('a11y.expandPanel') : t('a11y.collapsePanel')}
  ...
  <div class="app-shell__body">
    ...
    <!-- Área principal -->
    <main data-testid="main-content" class="app-shell__main" id="main-content" aria-label={t('a11y.mainContent')}>
      {#if loading}
