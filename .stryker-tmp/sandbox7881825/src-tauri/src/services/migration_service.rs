...
const MIGRATIONS: &[Migration] = &[
    ...
    Migration {
        version: 6,
        name: "M006_bes_document_cache",
        sql: include_str!("../../migrations/M006_bes_document_cache.sql"),
    },
    Migration {
        version: 7,
        name: "M007_cover_configs",
        sql: include_str!("../../migrations/M007_cover_configs.sql"),
    },
];
