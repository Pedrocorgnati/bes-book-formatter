...
use commands::bes_sync::{
    get_bes_metadata, invalidate_bes_cache, read_bes_docs, validate_bes_workspace,
};
use commands::cover::{
    calculate_spine_width, export_cover_image, generate_cover_pdf, get_cover_config,
    get_cover_templates, save_cover_config,
};
use commands::editorial_sync::{sync_editorial_progress, update_editorial_f10};
...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            upload_font,
            delete_custom_font,
            // BES Integration (module-6)
            validate_bes_workspace,
            read_bes_docs,
            get_bes_metadata,
            invalidate_bes_cache,
            sync_editorial_progress,
            update_editorial_f10,
