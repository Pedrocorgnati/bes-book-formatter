<script lang="ts">
  ...
  const stateLabel = $derived({
    pending:  t('illustrations.statePending'),
    imported: t('illustrations.stateImported'),
    linked:   t('illustrations.stateLinked'),
    error:    t('illustrations.stateError'),
  } as Record<string, string>);

  const stateClass: Record<string, string> = {
    pending:  'badge--gray',
    imported: 'badge--amber',
    linked:   'badge--green',
    error:    'badge--red',
  };
</script>
...
<article class="illustration-card" data-testid="illustration-card-{illustration.id}" aria-label={t('illustrations.ariaIllustration').replace('{name}', illustration.placeholderName)}>
  ...
  <div class="card-thumb">
    {#if illustration.imagePath && illustration.state !== 'pending'}
      <img
  ...
  <div class="card-actions">
    {#if illustration.state === 'imported'}
      <button
